...
function sectionhub_init() {
  ...
  if (!("lazySizesConfig" in window) && !("lazySizes" in window)) {
    ...
    !(function (a, b) {
            ...
            var e = b.widthmap[d] || d,
              ...
              h = {
                u: a
                  ...
                  .replace(
                    o,
                    f ? (g ? Math.round(d * f) : Math.round(d / f)) : "",
                  ),
                w: d,
              };
            ...
            if (a.detail.instance == c) {
              ...
              if (
                ...
                a.detail.dataAttr &&
                  ...
                  !j.disabled &&
                  (q =
                    b.getAttribute(i.sizesAttr) || b.getAttribute("sizes")) &&
                  r.test(q))
              ) {
                if (
                  ((d = h(b)),
      ...
      var w = (function () {
        ...
        return (
          v ? (j = function () {}) : addEventListener("lazybeforesizes", j),
          j
        );
      })();
    });
            ...
            var g,
              ...
              _ = A(function (a, b, c, e, f) {
                ...
                ((o = v(a, "lazybeforeunveil", b)).defaultPrevented ||
                  (e &&
                    (c ? s(a, d.autosizesClass) : a.setAttribute("sizes", e)),
                  (h = a[i](d.srcsetAttr)),
                  (g = a[i](d.srcAttr)),
                  f &&
          ...
          i = {
            ...
            getFit: function (a) {
              var b,
                ...
                j = {
                  fit:
                    a._lazysizesParentFit || a.getAttribute("data-parent-fit"),
                };
              return (
        ...
        var d = /\s+/g,
          ...
          k = function (a) {
            ...
            return (
              ...
              !i[b] &&
                i[a.style.backgroundSize] &&
                (b = a.style.backgroundSize),
              b
            );
          },
          l = function (a, b) {
    ...
    jQuery(".mdp").each(function () {
      ...
      if (
        ...
        $sh
          ...
          .addClass(lazySizesConfig.lazyClass);
      }
      if (
        ...
        $sh
          ...
          .addClass(lazySizesConfig.loadedClass);
      }
      if (
        ...
        $sh
          ...
          .addClass(lazySizesConfig.loadingClass);
      }
      if (
        lazySizesConfig.preloadClass &&
        lazySizesConfig.preloadClass != "lazypreload"
      ) {
        $sh
          .find(".lazyload")
          .removeClass("lazypreload")
          .addClass(lazySizesConfig.preloadClass);
      }
    });
  }
  ...
  !(function (t) {
    ...
    var h = 0,
      r = (function () {
        ...
        return (
          0 < i.search(s) &&
          ((i = s.exec(i).toString()), (i = i.split(" ")[1]), 9 > i) &&
      ...
      Array.prototype.indexOf ||
        (Array.prototype.indexOf = function (t, i) {
          ...
          var o = Object(this),
            e = o.length >>> 0;
          if (0 === e) return -1;
          if (((s = +i || 0), 1 / 0 === Math.abs(s) && (s = 0), s >= e))
            return -1;
          for (s = Math.max(0 <= s ? s : e - Math.abs(s), 0); s < e; ) {
            if (s in o && o[s] === t) return s;
            s++;
          }
          return -1;
        }));
    var n = function (o, e, h) {
      ((this.VERSION = "2.1.4"),
        (this.input = o),
        (this.plugin_count = h),
        (this.old_to =
      ...
      for (n in r) r.hasOwnProperty(n) && (r[n] || 0 === r[n] || delete r[n]);
      (o &&
        ((o = o.split(
          r.input_values_separator || e.input_values_separator || ";",
        )),
        o[0] && o[0] == +o[0] && (o[0] = +o[0]),
        o[1] && o[1] == +o[1] && (o[1] = +o[1]),
        e && e.values && e.values.length
          ? ((h.from = o[0] && e.values.indexOf(o[0])),
            (h.to = o[1] && e.values.indexOf(o[1])))
          : ((h.from = o[0] && +o[0]), (h.to = o[1] && +o[1]))),
        t.extend(h, e),
        t.extend(h, r),
        (this.options = h),
        this.validate(),
    ...
    ((n.prototype = {
      ...
      pointerUp: function (i) {
        this.current_plugin === this.plugin_count &&
          ...
          (t.contains(this.$cache.cont[0], i.target) || this.dragging) &&
      ...
      pointerDown: function (i, s) {
        ...
        var o =
          s.pageX ||
          (s.originalEvent.touches && s.originalEvent.touches[0].pageX);
        2 !== s.button &&
            ...
            if ("single" === this.options.type)
              ...
              (i
                ? (this.options.decorate_both
                    ? ((i = this.decorate(s[this.result.from])),
                      (i += this.options.values_separator),
                      (i += this.decorate(s[this.result.to])))
                    : (i = this.decorate(
                        s[this.result.from] +
                  ...
                  (s = this.decorate(s[this.result.to])))
                : (this.options.decorate_both
                    ? ((i = this.decorate(
                        this._prettify(this.result.from),
                        this.result.from,
              ...
              this.labels.p_to_left
                ...
                : ((this.$cache.from[0].style.visibility = "visible"),
                  ...
                  (this.$cache.single[0].style.visibility = "hidden")),
                (this.$cache.min[0].style.visibility =
                  s < this.labels.p_min + 1 ? "hidden" : "visible"),
                (this.$cache.max[0].style.visibility =
          ...
          : 100 === t
            ...
            : (h && (n = i = h.length),
              ...
              0 > o &&
                ...
                (e = +(e + a).toFixed(n))),
              (t = ((e - o) / 100) * t + o),
              (o = this.options.step.toString().split(".")[1])
                ? (t = +t.toFixed(o.length))
                : ((t /= this.options.step),
                  (t *= this.options.step),
                  (t = +t.toFixed(0))),
              a && (t -= a),
              (a = o ? +t.toFixed(o.length) : this.toFixed(t)),
              a < this.options.min
                ? (a = this.options.min)
      ...
      checkEdges: function (t, i) {
        return this.options.force_edges
          ? (0 > t ? (t = 0) : t > 100 - i && (t = 100 - i), this.toFixed(t))
          : this.toFixed(t);
      },
      validate: function () {
        var t,
        ...
        if (
          ...
          "string" == typeof s.keyboard_step &&
            (s.keyboard_step = +s.keyboard_step),
          ...
          for (
            ...
            ((t = +e[i]),
              isNaN(t) ? (t = e[i]) : ((e[i] = t), (t = this._prettify(t))),
              s.p_values.push(t));
        (("number" != typeof s.from || isNaN(s.from)) && (s.from = s.min),
          ("number" != typeof s.to || isNaN(s.from)) && (s.to = s.max),
          "single" === s.type
            ? (s.from < s.min && (s.from = s.min),
              s.from > s.max && (s.from = s.max))
            : ((s.from < s.min || s.from > s.max) && (s.from = s.min),
              (s.to > s.max || s.to < s.min) && (s.to = s.max),
          ...
          ("number" != typeof s.step ||
            ...
            0 > s.step) &&
            (s.step = 1),
          ("number" != typeof s.keyboard_step ||
            isNaN(s.keyboard_step) ||
            !s.keyboard_step ||
            0 > s.keyboard_step) &&
            (s.keyboard_step = 5),
      ...
      appendGrid: function () {
        if (this.options.grid) {
          ...
          for (
            this.calcGridMargin(),
              s.grid_snap
                ? ((h = t / s.step), (r = this.toFixed(s.step / (t / 100))))
                : (r = this.toFixed(100 / h)),
              4 < h && (a = 3),
              7 < h && (a = 2),
              14 < h && (a = 1),
              28 < h && (a = 0),
            ...
            for (
              ...
              ((c = this.toFixed(n - e * i)),
                (l +=
                  '<span class="irs-grid-pol small" style="left: ' +
                  c +
                  '%"></span>'));
            ((l +=
              '<span class="irs-grid-pol" style="left: ' + n + '%"></span>'),
              (c = this.convertToValue(n)),
              (c = s.values.length ? s.p_values[c] : this._prettify(c)),
              (l +=
      ...
      calcGridCollision: function (t, i, s) {
        ...
        for (o = 0; o < r && ((e = o + t / 2), !(e >= r)); o += t)
          ((h = this.$cache.grid_labels[e][0]),
            (h.style.visibility = s[o] <= i[e] ? "visible" : "hidden"));
      },
      ...
      (t.fn.ionRangeSlider = function (i) {
        return this.each(function () {
          t.data(this, "ionRangeSlider") ||
            t.data(this, "ionRangeSlider", new n(this, i, h++));
        });
      }),
      (function () {
        for (
          var t = 0, i = ["ms", "moz", "webkit", "o"], o = 0;
          o < i.length && !s.requestAnimationFrame;
          ++o
        )
          ((s.requestAnimationFrame = s[i[o] + "RequestAnimationFrame"]),
            (s.cancelAnimationFrame =
              s[i[o] + "CancelAnimationFrame"] ||
              s[i[o] + "CancelRequestAnimationFrame"]));
  ...
  !(function (t) {
    "AZ_jQueryBridget" in window ||
      ...
      (!(function (e, i) {
        "use strict";
        e.AZ_jQueryBridget = (function (t, e) {
      ...
      (("undefined" != typeof window ? window : this).AZ_EvEmitter =
        (function () {
          function t() {}
          var e = t.prototype;
          return (
        ...
        t.AZ_getSize = (function () {
          ...
          function a(e) {
            if (
              ...
              for (
                var l = (u.isBorderBox = "border-box" == h.boxSizing), c = 0;
                c < n;
                c++
              ) {
                var d = i[c],
      ...
      (function (e, i) {
        e.AZ_fizzyUIUtils = (function (e, i) {
          var n = {
            extend: function (t, e) {
              for (var i in e) t[i] = e[i];
              return t;
                ...
                t.forEach(function (t) {
                  if (t instanceof HTMLElement)
                    if (e) {
                      i(t, e) && o.push(t);
                      for (
                        var n = t.querySelectorAll(e), s = 0;
                        s < n.length;
                        s++
                      )
                        o.push(n[s]);
            ...
            (n.htmlInit = function (e, i) {
              n.docReady(function () {
                ...
                u.forEach(function (n) {
                  var s,
                    a = n.getAttribute(r) || n.getAttribute(l);
                  try {
                    s = a && JSON.parse(a);
                  } catch (t) {
                    return void (
                      o &&
                      o.error(
                        "Error parsing " + r + " on " + n.className + ": " + t,
                      )
                    );
                  }
                  var h = new e(n, s);
      ...
      (function (t, e) {
        ((t.AZ_Outlayer = {}),
          (t.AZ_Outlayer.Item = (function (t, e) {
            "use strict";
      ...
      (function (e, i) {
        "use strict";
        e.AZ_Outlayer = (function (e, i, n, o, s) {
          var r = e.console,
            a = function () {},
            h = 0,
            u = {};
          ...
          (o.extend(c, i.prototype),
            ...
            (c.dispatchEvent = function (e, i, n) {
              var o = i ? [i].concat(n) : n;
              if ((this.emitEvent(e, o), t))
                if (((this.$element = this.$element || t(this.element)), i)) {
                  var s = t.Event(i);
      ...
      (function (t, e) {
        ((t.AZ_Isotope = t.AZ_Isotope || {}),
          (t.AZ_Isotope.Item = (function (t) {
            "use strict";
            function e() {
      ...
      (function (t, e) {
        ((t.AZ_Isotope = t.AZ_Isotope || {}),
          (t.AZ_Isotope.LayoutMode = (function (t, e) {
            "use strict";
            function i(t) {
              ((this.isotope = t),
                t &&
      ...
      (function (t, e) {
        ...
        t.AZ_Masonry =
          ((i = t.AZ_Outlayer),
          (n = t.AZ_getSize),
          ((o = i.create("masonry")).compatOptions.fitWidth = "isFitWidth"),
      ...
      (function (t, e) {
        ...
        })(t.AZ_Isotope.LayoutMode, t.AZ_Masonry);
      })(window),
      (function (t, e) {
        !(function (t) {
          "use strict";
       ...
       */
      (function (e, i) {
        e.AZ_Isotope = (function (e, i, n, o, s, r, a) {
          ...
          e.AZ_Outlayer,
          e.AZ_getSize,
          e.AZ_matchesSelector,
          e.AZ_fizzyUIUtils,
          e.AZ_Isotope.Item,
          e.AZ_Isotope.LayoutMode,
        );
      })(window));
    /*!
     * Isotope PACKAGED v3.0.1
   ...
   */ !(function (o) {
    ...
    function (e, t, o) {
      ...
      var i = o(8),
        ...
        l = o.n(r),
        p = o(9);
      ((a.a.VideoWorker = a.a.VideoWorker || i.default),
        Object(p.default)(),
        l()(function () {
          void 0 !== a.a.jarallax &&
            a.a.jarallax(document.querySelectorAll("[data-jarallax-video]"));
        }));
    },
    function (e, t, o) {
      "use strict";
        ...
        v = (function () {
          function i(e, t) {
            ...
            ((o.url = e),
              ...
              o.videoID && ((o.ID = l), (l += 1), o.loadAPI(), o.init()));
          }
          var e, t, o;
          return (
            (e = i),
            (t = [
                  ...
                  a.videoImage
                    ...
                    : ("youtube" === a.type &&
                        ...
                        ((i = new Image()).onload = function () {
                          ...
                          o === e.length - 1
                            ? ((a.videoImage = "https://img.youtube.com/vi/"
                                .concat(a.videoID, "/")
                                .concat(e[o], ".jpg")),
                              t(a.videoImage))
                            : ((o += 1),
                      ...
                      "vimeo" === a.type &&
                        ...
                        (n.onreadystatechange = function () {
                          ...
                          4 === this.readyState &&
                            ...
                            (a.videoImage = e[0].thumbnail_large),
                            t(a.videoImage));
                        }),
                        n.send(),
                        (n = null)));
                    ...
                    : u.onAPIready(function () {
                        ...
                        (u.$video ||
                          ...
                          "youtube" === u.type &&
                            ...
                            u.options.showContols ||
                              ((u.playerOptions.playerVars.iv_load_policy = 3),
                            ...
                            (u.playerOptions.events = {
                              onReady: function (t) {
                                (u.options.mute
                                  ? t.target.mute()
                                  : u.options.volume &&
                                    t.target.setVolume(u.options.volume),
                                  u.options.autoplay &&
                                    u.play(u.options.startTime),
                                  u.fire("ready", t),
                                  u.options.loop &&
                                    !u.options.endTime &&
                                    (u.options.endTime =
                                      u.player.getDuration() - 0.1),
                              ...
                              onStateChange: function (e) {
                                (u.options.loop &&
                                  e.data === s.a.YT.PlayerState.ENDED &&
                                  u.play(u.options.startTime),
                                  t ||
                                    e.data !== s.a.YT.PlayerState.PLAYING ||
                                    ((t = 1), u.fire("started", e)),
                                  e.data === s.a.YT.PlayerState.PLAYING &&
                                    u.fire("play", e),
                                  e.data === s.a.YT.PlayerState.PAUSED &&
                                    u.fire("pause", e),
                                  e.data === s.a.YT.PlayerState.ENDED &&
                                    u.fire("ended", e),
                                  e.data === s.a.YT.PlayerState.PLAYING
                            ...
                            (u.player =
                              u.player ||
                              new s.a.YT.Player(u.playerID, u.playerOptions)),
                            i &&
                              ((u.$video = document.getElementById(u.playerID)),
                              (u.videoWidth =
                                parseInt(u.$video.getAttribute("width"), 10) ||
                                1280),
                              (u.videoHeight =
                                parseInt(u.$video.getAttribute("height"), 10) ||
                                720))),
                          "vimeo" === u.type &&
                            ((u.playerOptions = {
                              id: u.videoID,
                            ...
                            u.options.volume &&
                              (u.playerOptions.volume = u.options.volume),
                            u.options.showContols ||
                              ((u.playerOptions.badge = 0),
                              (u.playerOptions.byline = 0),
                              (u.playerOptions.portrait = 0),
                              (u.playerOptions.title = 0),
                              (u.playerOptions.background = 1)),
                            u.$video ||
                              ((a = ""),
                              Object.keys(u.playerOptions).forEach(
                                function (e) {
                                  ("" !== a && (a += "&"),
                                    (a += ""
                                      .concat(e, "=")
                                      .concat(
                                        encodeURIComponent(u.playerOptions[e]),
                                      )));
                                },
                              ),
                              (u.$video = document.createElement("iframe")),
                              u.$video.setAttribute("id", u.playerID),
                              u.$video.setAttribute(
                                "src",
                            ...
                            (u.player =
                              u.player ||
                              new s.a.Vimeo.Player(u.$video, u.playerOptions)),
                            u.options.startTime &&
                              u.options.autoplay &&
                              u.player.setCurrentTime(u.options.startTime),
                            ...
                            u.player.on("timeupdate", function (e) {
                              (r || (u.fire("started", e), (r = 1)),
                                u.fire("timeupdate", e),
                                u.options.endTime &&
                                  u.options.endTime &&
                                  e.seconds >= u.options.endTime &&
                                  (u.options.loop
                                    ? u.play(u.options.startTime)
                                    : u.pause()));
                            }),
                          ...
                          "local" === u.type &&
                            (u.$video ||
                              ((u.$video = document.createElement("video")),
                              u.options.showContols && (u.$video.controls = !0),
                              u.options.mute
                                ? (u.$video.muted = !0)
                                : u.$video.volume &&
                                  (u.$video.volume = u.options.volume / 100),
                              ...
                              Object.keys(u.videoID).forEach(function (e) {
                                ...
                                ((t = u.$video),
                                  (o = u.videoID[e]),
                                  (i = "video/".concat(e)),
                                  ((n = document.createElement("source")).src =
                                    o),
                                  (n.type = i),
                                  t.appendChild(n));
                              })),
                            ...
                            u.player.addEventListener(
                              "timeupdate",
                              function (e) {
                                (u.fire("timeupdate", e),
                                  u.options.endTime &&
                                    u.options.endTime &&
                                    this.currentTime >= u.options.endTime &&
                                    (u.options.loop
                                      ? u.play(u.options.startTime)
                                      : u.pause()));
                              },
                ...
                value: function () {
                  if (!p || !u) {
                    ...
                    if (
                      ("youtube" !== this.type ||
                        p ||
                        ((p = 1), (o = "https://www.youtube.com/iframe_api")),
                      "vimeo" === this.type && !u)
                    ) {
              ...
              },
              {
                ...
                value: function (e) {
                  var t;
                  ("youtube" === this.type &&
                    ((void 0 !== s.a.YT && 0 !== s.a.YT.loaded) || d
                      ? "object" === n(s.a.YT) && 1 === s.a.YT.loaded
                        ? e()
                        : y.done(function () {
                            e();
                          })
                      ...
                      (void 0 !== s.a.Vimeo || c
                        ...
                        : ((c = 1),
                          (t = setInterval(function () {
                            void 0 !== s.a.Vimeo &&
                              (clearInterval(t), m.resolve("done"), e());
                          }, 20)))),
                    "local" === this.type && e());
                },
              },
        ...
        void 0 !== a &&
          ...
          (e.prototype.onScroll = function () {
            ...
            (t.apply(o),
              o.isVideoInserted ||
                !o.video ||
                (o.options.videoLazyLoading && !o.isElementInViewport) ||
                ...
                o.video.getVideo(function (e) {
                  ...
                  (o.css(e, {
                    ...
                    "local" === o.video.type &&
                      (o.image.src
                        ? o.$video.setAttribute("poster", o.image.src)
                        : o.image.$item &&
                          "IMG" === o.image.$item.tagName &&
                          o.image.$item.src &&
                          o.$video.setAttribute("poster", o.image.$item.src)),
                    o.image.$container.appendChild(e),
                    t.parentNode.removeChild(t));
                })));
          }),
          (l = e.prototype.coverImage),
          (e.prototype.coverImage = function () {
            ...
            return (
              a &&
                ...
                r &&
                ("IFRAME" === r || "VIDEO" === r) &&
                ((t = ((e = a.image.height) * n.image.width) / n.image.height),
                (o = (a.container.width - t) / 2),
                (i = a.image.marginTop),
                a.container.width > t &&
                  ((e =
                    ((t = a.container.width) * n.image.height) / n.image.width),
                  (o = 0),
                  (i += (a.image.height - e) / 2)),
                "IFRAME" === r && ((e += 400), (i -= 200)),
                n.css(n.$video, {
                  width: "".concat(t, "px"),
          ...
          (e.prototype.canInitParallax = function () {
            ...
            function i() {
              o.image.$default_item &&
                ((o.image.$item = o.image.$default_item),
            ...
            if (t.isValid())
              if (
                ...
                if (
                  (t.on("ready", function () {
                    var e;
                    o.options.videoPlayOnlyVisible
                      ? ((e = o.onScroll),
                        (o.onScroll = function () {
                          (e.apply(o),
                            o.videoError ||
                              (!o.options.videoLoop &&
                                (o.options.videoLoop || o.videoEnded)) ||
                ...
                o.defaultInitImgResult ||
                  t.getImageURL(function (e) {
                    ...
                    (t &&
                      o.$item.setAttribute("data-jarallax-original-styles", t),
                      o.css(o.$item, {
  ...
  (function ($) {
    ...
    window.mdp.init = function ($wrapper) {
      ...
      function mega_menu($wrapper) {
        ...
        $wrapper.find("[data-mega-menu]:not(.mdp-mega-menu)").each(function () {
          ...
          $mega.find(".mdp-sub-menu").each(function () {
            var $sub_menu = $(this);
            if (
              $sub_menu.parents(".mdp-mega-menu").length === 0 &&
                  ...
                  if ($(window).scrollTop() > $sticky.data("top")) {
                    ...
                    if ($sticky.data("sticky-style")) {
                      if ($sticky.closest(".mdp-sticky").length) {
                        $sticky
                          .closest(".mdp-sticky")
                          .attr("style", $sticky.data("sticky-style"));
                      } else {
      ...
      function magnific_gallery($wrapper) {
        if ("magnificPopup" in $.fn) {
          if (
            ...
            $wrapper.find('img, [style*="background-image"]').length
          ) {
            ...
            $wrapper.find('img, [style*="background-image"]').each(function () {
              var $this = $(this);
              if (
                ($this.parentsUntil($wrapper).filter("a").length === 0 &&
                  $this.find("a").length === 0) ||
                ($this.parentsUntil($wrapper).filter("a").length &&
                  $this.parentsUntil($wrapper).filter("a").attr("href") == "/")
              ) {
      ...
      function update_price($product, selected_variant) {
        if (selected_variant.compare_at_price) {
          $product
            .find(".mdp-price-wrapper .mdp-price .mdp-price-compare")
            .html(
              formatMoney(selected_variant.compare_at_price, mdp.money_format),
            );
        } else {
          $product
            .find(".mdp-price-wrapper .mdp-price .mdp-price-compare")
        ...
        $product
          .find(".mdp-price-wrapper .mdp-price .mdp-price-varies")
          .html(formatMoney(selected_variant.price, mdp.money_format));
        if (selected_variant.unit_price_measurement) {
          $product
            .find(".mdp-price-wrapper .mdp-unit-price")
            .html(
              " " +
                formatMoney(selected_variant.unit_price, mdp.money_format) +
                "/" +
      ...
      function update_pickup_availability($product, selected_variant) {
        $.get(
          "/variants/" +
            selected_variant.id +
            "/?section_id=mdp-pickup-availability",
          function (data) {
            ...
            $container
              ...
              .on("click", function () {
                var $modal = $container.find(
                  ".mdp-pickup-availabilities-modal",
                );
                var $overlay = $(".mdp-right-side-popup-overlay");
                if (!$overlay.length) {
                  $overlay = $(
                    '<div class="mdp-right-side-popup-overlay"></div>',
                  ).appendTo("body");
                }
                var $wrapper = $(".mdp-right-side-popup-wrapper");
                if (!$wrapper.length) {
                  $wrapper = $(
                    '<div class="mdp-right-side-popup-wrapper"></div>',
                  ).appendTo("body");
                }
                $wrapper
                  .empty()
                  .html(
                    '<div class="mdp-pickup-availabilities-modal">' +
                      $modal.html() +
                      "</div>",
                  );
      ...
      $wrapper.find(".mdp-product .mdp-content").each(function () {
        var $content = $(this);
        if (
          $content.children().length == $content.children("h1,h2,h3,p").length
        ) {
          var accordion = [];
          ...
          if (accordion.length) {
            ...
            accordion.forEach(function (item, index) {
              $accordion.append(
                '<div class="mdp-item ' +
                  (!index ? "mdp-active" : "") +
                  '"><div class="mdp-heading">' +
                  item.heading +
                  '</div><div class="mdp-content">' +
                  item.content +
                  "</div></div>",
              );
            });
          ...
          $this.magnificPopup({
            ...
            iframe: {
              markup:
                ...
                '<iframe class="mfp-iframe" frameborder="0" allowfullscreen src=' +
                url +
                "></iframe>" +
                "</div>",
              srcAction: false,
          ...
          if ($this.is(".mdp-available")) {
            ...
            $.post({
              ...
              .done(function (item) {
                ...
                var count = parseInt(
                  $wrapper.find(".mdp-cart-count").text(),
                  10,
                );
                count =
                  count +
      ...
      $wrapper.find(".mdp-add-to-wishlist").each(function () {
        ...
        $this.off("click").on("click", function () {
          ...
          if ($this.attr("data-product-handle") in wishlist) {
            ...
            var existingPopup = $("#wishlist-popup");
      ...
      $wrapper
        .find(".mdp-quantity-wrapper .mdp-quantity-minus")
        .off("click")
        .on("click", function () {
      ...
      $wrapper
        .find(".mdp-quantity-wrapper .mdp-quantity-plus")
        .off("click")
        .on("click", function () {
          var $input = $(this).closest(".mdp-quantity-wrapper").find("input");
          $input.val(parseInt($input.val(), 10) + 1);
      ...
      $wrapper
        .find(".mdp-product-options .mdp-separated select")
        .on("change", function () {
          function get_selected_variant($wrapper) {
            ...
            if (product) {
              if ("variants" in product) {
                let total = $wrapper.find(
                  ".mdp-option select[data-index]",
                ).length;
                product.variants.forEach(function (variant) {
                  let matched = 0;
                  $wrapper
                    .find(".mdp-option select[data-index]")
                    .each(function () {
                      let $select = $(this);
          ...
          let $select = $(this);
          let selected_variant = get_selected_variant(
            $select.closest(".mdp-separated"),
          );
          if (selected_variant) {
            let $product = $select.closest(".mdp-product");
            update_add_to_cart($product, selected_variant);
            if (selected_variant.featured_media) {
              let $image = $product.find(
                '.mdp-product-swiper [data-media-id="' +
                  selected_variant.featured_media.id +
                  '"]',
              );
              if ($image.length) {
                let $slider = $image.closest(".mdp-product-swiper");
                $slider[0].swiper.slideTo(
                  $slider
                    .find(".mdp-swiper-wrapper")
                    .children()
                    .index($image.closest(".mdp-swiper-slide")),
                );
              }
            }
      ...
      $wrapper.find(".mdp-hover-zoom").each(function () {
        ...
        $("<img/>")
          ...
          .one("load", function () {
            ...
            var $zoom = $('<div class="mdp-zoom-result"></div>')
              .appendTo($this)
              .css({
      ...
      $wrapper.find(".mdp-collection-sidebar").each(function () {
        function parseUrl() {
          ...
          var is_custom_filter =
            current.url.indexOf("custom-filter") != -1 ? true : false;
        ...
        function buildUrl(unset_url_params) {
          ...
          if (controls.params) {
            if (
              ...
              window.mdp.default.only_available
            ) {
              ...
              $.each(
                ...
                function (i, v) {
                  if (controls.params[this]) {
                    ...
                    var value =
                      name +
                      controls.params[v].join(v === "price" ? "-" : name);
          ...
          if (params) current.url += "?" + decodeURIComponent(params);
          if (params_ajax)
        ...
        function parseControls() {
          ...
          $.each(["collection"], function () {
            ...
            if (value) controls[this] = value;
          });

          if (!controls.collection) controls.collection = url.collection;
        ...
        function setControls() {
          ...
          $container
            .find('[name="collection"][value="' + this.url.collection + '"]')
            .prop("checked", true);
          ...
          $container
            ...
            .val(url.params && url.params["title"] ? url.params["title"] : "");
        ...
        function checkCurrentFilters(params) {
          ...
          $current_filter[
            params && Object.keys(params).length ? "removeClass" : "addClass"
          ]("mdp-hidden");
        }
        function loadContent(current_obj, event_type, callback) {
          ...
          xhr = $.ajax({
            ...
            success: function (data) {
              ...
              $container
                .find("[data-mdp-collection-replace]")
                .each(function () {
                  var $this = $(this),
                    full_replace = $this.is(
                      "[data-mdp-collection-replace-only-full]",
                    );
                  ...
                  var name = $this.attr("data-mdp-collection-replace"),
                    $element = $container.find(
                      '[data-mdp-collection-replace="' + name + '"]',
                    ),
                  ...
                  if (
                    event_type === "page" &&
                    $element.attr("data-mdp-collection-replace-method") ===
                      "add"
                  ) {
                    ...
                    if (
                      $page_element.is(".mdp-collection-replace-hide-empty")
                    ) {
                      $widget = $page_element.parents(
                        "[data-mdp-collection-widget]",
                      );
                      $widget[
        ...
        var $current_filter = $sidebar.find(
          '[data-mdp-collection-widget="current_filters"]',
        );
        ...
        $sidebar.on("change", ".mdp-collections-menu input", function () {
          ...
          if (name === "collection") {
            $container
              .find(
                '.mdp-collections-menu [name="collection_with_tag"]:checked',
              )
              .prop("checked", false);
            $container
              .find(
            ...
            var $current_collection = $this
                .parents(".mdp-collections-menu-item")
                .find('[name="collection"]'),
              $remove_collections = $container
                .find('.mdp-collections-menu [name="collection"]:checked')
        ...
        $sidebar.on(
          "click",
          '.mdp-collections-menu [name="collection"]:checked',
          function () {
            var $this = $(this),
        ...
        $sidebar.on(
          "click",
          ".mdp-collection-filter-by-title button",
          function () {
            onChangeControls();
          },
        );
        ...
        $sidebar.on(
          "keyup",
          ".mdp-collection-filter-by-title input",
        ...
        $container.on(
          "change",
          ".mdp-collection-sort-by select, .mdp-collection-view-length select",
          function () {
            onChangeControls();
          },
        );
        ...
        $sidebar.on(
          "click",
          ".mdp-collection-current-tags [data-value]",
          function () {
            var $this = $(this),
        ...
        $sidebar.on("click", ".mdp-collection-current-tags-clear", function () {
          $container
            .find(".mdp-collection-current-tags [data-value]")
            .each(function () {
              var $this = $(this),
                value = $this.attr("data-value"),
                type = $this.attr("data-filter-type");
      ...
      if (collection_filtering && collection_filtering.length) {
        $wrapper.find(".mdp-filter").on("click", function () {
          ...
          if (!$overlay.length) {
            $overlay = $(
              '<div class="mdp-left-side-popup-overlay"></div>',
            ).appendTo("body");
          }
          var $wrapper = $(".mdp-left-side-popup-wrapper");
          if (!$wrapper.length) {
            $wrapper = $(
              '<div class="mdp-left-side-popup-wrapper mdp"></div>',
            ).appendTo("body");
          }
          $wrapper
            .empty()
            .html(
              '<form class="mdp-collection-filtering">' +
      ...
      $wrapper.find(".mdp-collection-filtering").each(function () {
        ...
        $filtering
          .find(".mdp-collection-filters input")
          .on("change", function () {
            setTimeout(function () {
              $filtering.submit();
            });
      ...
      $wrapper.find(".mdp-cart-table").each(function () {
        ...
        $cart
          .find('.mdp-cart-submit-controls [type="submit"]')
          .on("click", function () {
            $cart
              .find('.mdp-cart-update-wrapper input[name="updates[]"]')
              .remove();
          });
      });
      ...
      $wrapper.find(".mdp-comparison-table").each(function () {
        ...
        $products.find(".mdp-product").each(function () {
          ...
          var parameters = $.trim(
            htmlToText($product.find(".mdp-parameters").html()),
          ).split("\n");
        ...
        names.forEach(function (name) {
          ...
          values.forEach(function (parameters) {
            $tr.append(
              "<td>" + (name in parameters ? parameters[name] : "") + "</td>",
            );
          });
        });
      });
      ...
      $wrapper.find(".mdp-menu-element").each(function () {
        ...
        $menu.children("label").on("click", function () {
          ...
          $wrapper
            .find(".mdp-down-icon")
            .html($("#mdp-right-icon").html())
            .removeClass("mdp-down-icon")
            .addClass("mdp-right-icon");
          $wrapper
            .find(".mdp-menu-root > .mdp-menu-item > .mdp-sub-menu")
            .prepend(
              '<div class="mdp-back">' +
                $("#mdp-left-icon").html() +
                "<span>" +
          ...
          let itemsParent =
            $menu_wrapper[0].querySelectorAll(".mdp-has-children");
                  ...
                  shipping_rates.map((rate) => {
                    $shippingContent.append(
                      "<p>" +
                        rate.name +
                        ": " +
                        formatMoney(rate.price, mdp.money_format) +
                        "</p>",
                    );
                  });
                } else {
      ...
      $wrapper
        .find('test[name="checkout"][type="submit"]')
        .on("click", function () {
    ...
    $(function () {
      ...
      $(document)
        .off("shopify:section:load.mdp")
        .on("shopify:section:load.mdp", function (evt) {
  ...
  let loadProductRecommendationsIntoSection = function () {
    let productRecommendationsSection = document.querySelector(
      ".mdp-weare-product-recommendations",
    );
    ...
    let requestUrl =
      baseUrl +
      "?section_id=mdp-weare-product-recommendations&product_id=" +
      productId +
      "&limit=12";
